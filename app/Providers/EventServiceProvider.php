...
//            'App\Listeners\DecreaseBreederLittersCount',
        ...
        'App\Events\KitWasRevived' => [
            'App\Listeners\ManageKitRevival@updateLitterStats',
            'App\Listeners\ManageKitRevival@updateBreederStats',
        ],
        ...
        'App\Events\KitWasSold' => [
            'App\Listeners\ManageKitsSold',
        ],
    ];
